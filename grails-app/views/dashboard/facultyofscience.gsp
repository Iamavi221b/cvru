        ...
        <div class="row">
            <div class="col-md-12">
                <div class="services-contentCourses">
                    <div class="container">
                        <h4>FACULTY OF SCIENCE - Courses & Fees</h4><br>
                        <table class="table  hidden-sm hidden-xs">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Master of Science (Maths)</td>
                                <td>Graduation in B.Sc(Maths)</td>
                                <td>2 Year</td>
                                <td>14400</td>
                                <td>1500</td>
                            </tr>
                    ...
                    <g:link action="download" id="${2}" ><h3>Download PDF <i class="fa fa-download" aria-hidden="true"></i></h3></g:link>
                </div>
            </div>
        </div>
