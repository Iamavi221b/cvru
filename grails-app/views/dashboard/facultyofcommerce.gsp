        ...
        <div class="row">
            <div class="col-md-12">
                <div class="services-contentCourses">
                    <div class="container">
                        <h4>FACULTY OF COMMERCE - Courses & Fees</h4><br>
                        <table class="table  hidden-sm hidden-xs">
                            ...
                            <tr class="info">
                                ...
                                <td>12th Pass from Science and Commerce</td>
                                <td>3 Year</td>
                                <td>5200</td>
                                <td>1500</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>Bachelor of Commerce (Banking)</td>
                                <td>12th Pass from Science and Commerce</td>
                                <td>3 Year</td>
                                <td>6900</td>
                                <td>1500</td>
                            ...
                            <tr class="info">
                                <td>4</td>
                                <td>Bachelor of Commerce (Computer Application)</td>
                                <td>12th Pass from Science and Commerce</td>
                                <td>3 Year</td>
                                <td>4600</td>
                                <td>1500</td>
                    ...
                    <g:link action="download" id="${3}" ><h3>Download PDF <i class="fa fa-download" aria-hidden="true"></i></h3></g:link>
                </div>
            </div>
        </div>
