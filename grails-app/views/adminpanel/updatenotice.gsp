...
<div class="container">
    <div class="row">
        <g:uploadForm action="updateNotice" method="post"  id="${notice.id}">
            <div class="form-group">
                <label>Title:</label>
                <input type="text" class="form-control" name="title" value="${notice.title}" required autofocus/>
            </div>
            <div class="form-group">
                <label>Description/Content:</label>
                <textarea class="form-control" rows="8" name="content">${notice.content}</textarea>
            </div>
            <div class="form-group">
                <label>Upload an image or file:</label>
                <input type="file" name="file" value="${notice.doc.id}">
            </div>
            <div class="form-group">
