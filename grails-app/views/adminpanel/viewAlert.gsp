...
<div class="container">
    <div class="row">
        <h2>${alert.title}</h2>
        <g:link controller="adminpanel" action="updateAlert" class="btn btn-primary" id="${alert.id}">Update</g:link>
        <g:link controller="adminpanel" action="deleteAlert" class="btn btn-danger" id="${alert.id}"> Delete</g:link>
        <h4>
            <br>
            ${alert.content}
            <br>
