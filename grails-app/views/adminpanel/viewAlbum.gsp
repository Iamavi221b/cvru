...
------------------------------------------------------------------------------------------------------------->
<div id="main-content">
    <h2>${album.albumName} <g:link controller="adminpanel" action="addImage" class="btn btn-primary" id="${album.id}"> Add Image </g:link>  <g:link controller="adminpanel" action="deleteAlbum" class="btn btn-danger" id="${album.id}"> Delete Album</g:link><br/>
    </h2><hr>
    <div id="gallery" class="container">

        <g:each in="${album.imageInstances}">
            <asset:image src="uploads/${album.albumName}/${it.filename}" class="card img-responsive"/>
            <g:link controller="adminpanel" action="deleteImage" class="btn btn-danger" id="${it.id}">Delete</g:link>
        </g:each>
    </div>
