        ...
        <div class="row">
            <div class="col-md-12">
                <div class="services-contentCourses">
                    <div class="container">
                        <h4>FACULTY OF MANAGEMENT - Courses & Fees</h4><br>
                        <table class="table  hidden-sm hidden-xs">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Post Graduate Diploma in Business Management (PGDBM)</td>
                            ...
                            <tr class="info">
                                <td>2</td>
                                <td>Post Graduate Diploma in Marketing Management (PGDMM)</td>
                                <td>Graduate in any Discipline</td>
                                <td>1 Year</td>
                                <td>7500</td>
                                <td>1500</td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>Post Graduate Diploma in Insurance and Risk Management (PGDIRM)</td>
                                <td>Graduate in any Discipline</td>
                                <td>1 Year</td>
                                <td>7500</td>
                                <td>1500</td>
                            ...
                            <tr class="info">
                                <td>4</td>
                                <td>Bachelors of Business Administration (BBA)</td>
                                <td>12th Pass</td>
                                <td>3 Year</td>
                                <td>6500</td>
                                <td>1500</td>
                            ...
                            <tr class="info">
                                <td>6</td>
                                <td>Master of Business Administration Lateral Entry (MBA LE)</td>
                                <td>Graduate in any Discipline</td>
                                <td>2 Year</td>
                                <td>15600</td>
                                <td>1500</td>
                    ...
                    <g:link action="download" id="${5}" ><h3>Download PDF <i class="fa fa-download" aria-hidden="true"></i></h3></g:link>
                </div>
            </div>
        </div>
