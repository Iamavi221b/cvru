        ...
        <div class="row">
            <div class="col-md-12">
                <div class="services-contentCourses">
                    <div class="container">
                        <h4>FACULTY OF INFORMATION TECHNOLOGY - Courses & Fees</h4><br>
                        <table class="table  hidden-sm hidden-xs">
                            ...
                            <tr>
                                ...
                                <th>*EXAM FEES PER YEAR</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>1</td>
                                <td>Diploma in Copmuter Application(DCA)</td>
                                <td>12th Pass</td>
                                <td>1 Year</td>
                                <td>4600</td>
                                <td>1500</td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>Bachelors of Computer Application (BCA)</td>
                                <td>12th Pass</td>
                                <td>3 Year</td>
                                <td>7500</td>
                                <td>1500</td>
                            ...
                            <tr class="info">
                                <td>4</td>
                                <td>Master of Science in Information Technology (M.Sc. (IT))</td>
                            ...
                            <tr>
                                <td>5</td>
                                <td>Master of Science in Information Technology Lateral Entry M.Sc. IT (LE)</td>
                                <td>Graduate in any Subject</td>
                                <td>1 Year</td>
                                <td>6900</td>
                                <td>1500</td>
                            ...
                            <tr class="info">
                                <td>6</td>
                                <td>Post Graduate Diploma in Computer Hardware and Maintenance (PGDCHME)</td>
                                <td>Graduate in any Discipline</td>
                                <td>1 Year</td>
                                <td>6400</td>
                                <td>1500</td>
                    ...
                    <p class=" hidden-sm hidden-xs">^Admission Fees: To be paid in Single installement at the time of Admission as per prospectus by e-wallet on aisectonline.com Portal. Course material shall be supplied by AISECT LTD.<br><br>
                        *Exam Fees per year: To be paid at the time of Examination form submission by e-wallet on aisectonline.com portal.</p>
                    <g:link action="download" id="${4}" ><h3>Download PDF <i class="fa fa-download" aria-hidden="true"></i></h3></g:link>
                </div>
            </div>
        </div>
