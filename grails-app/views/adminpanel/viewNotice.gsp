...
<div class="container">
    <div class="row">
        <h2>${notice.title}</h2>
        <g:link controller="adminpanel" action="updatenotice" class="btn btn-primary" id="${notice.id}">Update</g:link>
        <g:link controller="adminpanel" action="deletenotice" class="btn btn-danger" id="${notice.id}"> Delete</g:link>
        <h4>
            <br>
            ${notice.content}
            <br>
