...
<div class="container">
    <div class="row">
        <h2>Add Album</h2>
        <g:uploadForm action="saveAlbum" method="post">
            <div class="form-group">
                <label for="albumName">Album Name</label>
                <input type="text" id="albumName" class="form-control" name="album" autofocus/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="submit" class="btn-primary btn" value="Add Album"/><a href="#" onclick="javascript:window.history.back();"><div class="btn btn-default">Back</div> </a>
            </div>
        </g:uploadForm>
    </div>
</div>
