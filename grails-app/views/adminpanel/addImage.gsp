...
<div class="container">
    <div class="row">
        <h2>Add Images to ${albumInstance.albumName}</h2>
        <g:uploadForm action="saveImage" method="post"  id="${albumInstance.id}">
            ...
            <div class="form-group">
                <input type="submit" class="btn-primary btn" value="Save"/><a href="#" onclick="javascript:window.history.back();"><div class="btn btn-default">Back</div> </a>
            </div>
        </g:uploadForm>
    </div>
</div>
