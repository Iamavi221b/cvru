    ...
    <div class="row">
      <div class="col-md-12">
        <div class="services-contentCourses">
          <div class="container">
            <h4>FACULTY OF ARTS - Courses & Fees</h4><br>
            <table class="table  hidden-sm hidden-xs">
              ...
              <tr>
                <td>1</td>
                <td>Master of Art (English Literature)</td>
                <td>Graduation</td>
                <td>2 Year</td>
                <td>5800</td>
                <td>1500</td>
              ...
              <tr class="info">
                <td>2</td>
                <td>Master of Art (Hindi Literature)</td>
                <td>Graduation</td>
                <td>2 Year</td>
                <td>5800</td>
                <td>1500</td>
          ...
          <h3><a href="facultyofcommerce.html" download>Download PDF <i class="fa fa-download" aria-hidden="true"></i></h3>
        </div>
      </div>
    </div>
